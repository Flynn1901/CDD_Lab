...
--               d:/PROJECT/XILINX/CDD/LAB02/LAB02/LAB02.srcs/sources_1/bd/design_1/ip/design_1_uart_top_0_0/design_1_uart_top_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_uart_top_0_0_uart_rx is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_rFSM_Current[0]_i_1__0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \FSM_onehot_rFSM_Current[2]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FSM_onehot_rFSM_Current[2]_i_5\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \rBit_Current[1]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rBit_Current[2]_i_2__0\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rBit_Current[2]_i_3__0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \rBuffer_reg[72]_srl10___inst_rBuffer_reg_r_8_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rBuffer_reg[73]_srl10___inst_rBuffer_reg_r_8_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rBuffer_reg[74]_srl10___inst_rBuffer_reg_r_8_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rBuffer_reg[75]_srl10___inst_rBuffer_reg_r_8_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rBuffer_reg[76]_srl10___inst_rBuffer_reg_r_8_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rBuffer_reg[77]_srl10___inst_rBuffer_reg_r_8_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rBuffer_reg[78]_srl10___inst_rBuffer_reg_r_8_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \rBuffer_reg[79]_srl10___inst_rBuffer_reg_r_8_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \rRxData_Current[7]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rRxData_Current[7]_i_3\ : label is "soft_lutpair2";
...
\rBit_Current[2]_i_3__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
architecture STRUCTURE of design_1_uart_top_0_0_uart_tx is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_rFSM_Current[4]_i_1\ : label is "soft_lutpair14";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_rFSM[2]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \rBit_Current[0]_i_2\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \rCnt[3]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \rCnt_Current[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rCnt_Current[10]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \rCnt_Current[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rCnt_Current[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rCnt_Current[7]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rCnt_Current[8]_i_1\ : label is "soft_lutpair8";
...
architecture STRUCTURE of design_1_uart_top_0_0_uart_top is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of rBuffer_reg_gate : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \rBuffer_reg_gate__0\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \rBuffer_reg_gate__1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \rBuffer_reg_gate__2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \rBuffer_reg_gate__3\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \rBuffer_reg_gate__4\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \rBuffer_reg_gate__5\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \rBuffer_reg_gate__6\ : label is "soft_lutpair20";
begin
...
UART_RX_INST: entity work.design_1_uart_top_0_0_uart_rx
     port map (
      \FSM_onehot_rFSM_Current_reg[4]_0\(0) => wRxDone,
      Q(0) => rFSM(1),
      iClk => iClk,
      iRst => iRst,
      iRx => iRx,
